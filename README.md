# ProWidget Systems – Customer Spending Analysis by City
...
Are different cities underserved?

This requires us to calculate total customer spending by city and find cities with the lowest customer spending.

How does London compare to the rest of the United Kingdom?

This can then be answered from the output of the first answer.
...
2. Try to extract city column from address
3. Create city column from external list
4. Explore new city column
5. Analyze and visualize spend by city and London versus rest of United Kingdom
